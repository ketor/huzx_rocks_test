ROCKSDB_BASE_PATH=/home/git/facebook/rocksdb
...
TERARKDB_BASE_PATH=/home/git/bytedance/terarkdb/build
...
rocks:
	...
	g++ -L${ROCKSDB_BASE_PATH} huzx_rocksdb.o  -lrocksdb -o huzx_rocksdb
